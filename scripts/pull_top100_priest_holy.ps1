...
#
# Generated from pull_top100_TEMPLATE.ps1 for Priest / Holy spec.
#
...
$className = "Priest"      # Must match the WCL sourceclass name exactly (Druid, Shaman, Priest, Paladin, ...)
$classID = 7                # From GET /classes - e.g. Druid=2, Paladin=6, Priest=7, Shaman=9
$specID = 2                 # Healing spec ID within that class - e.g. Druid Restoration=4, Paladin Holy=1,
